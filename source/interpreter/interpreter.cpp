...
namespace kvantum::interpreter
{
   ...
   {
       auto evalArgs = [this](vector<Expression*> arguments) { return apply(ITER_THROUGH(arguments), std::function([this](Expression* e) {
           return eval(e);
       })); };
   ...
   any Interpreter::visit(Cast* cat)
   {
       return (Value*)new VoidValue();
   }
